...
<script src="<?= base_url()?>assets/extensions/datatables.net-bs5/js/jquery.dataTables.min.js"></script>
<script src="<?= base_url()?>assets/extensions/datatables.net-bs5/js/dataTables.bootstrap5.min.js"></script>
<script src="<?= base_url()?>assets/extensions/perfect-scrollbar/perfect-scrollbar.min.js"></script>
<script src="<?= base_url()?>assets/extensions/select2/js/select2.min.js"></script>
...
<script src="<?= base_url()?>assets/static/js/pages/quill.js"></script>
...
<script src="<?= base_url()?>assets/compiled/js/bootstrap.js"></script>
