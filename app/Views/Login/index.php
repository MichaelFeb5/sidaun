...
<head>
    ...
    <link rel="stylesheet" href="assets/extensions/sweetalert2/sweetalert2.css" />
</head>
        ...
        <div class="row rounded-5 p-3 bg-white shadow box-area">
            ...
            <div class="col-md-6 rounded-4 d-flex justify-content-center align-items-center flex-column left-box">
                <div class="featured-image mb-3">
                    <img src="assets/images/login/casual-life-3d-monstera-plant-with-holes-in-its-leaves.png" class="img-fluid" style="width: 180px;">
                </div>
            </div>
            ...
            <div class="col-md-6 right-box">
                <div class="row align-items-center">
                    <div class="header-text mb-3">
                        <h2>Welcome back!</h2>
                        <p>Please enter your SiDaun account to continue exploring the plants in the botanical garden.</p>
                    </div>
                    ...
                    <div class="input-group mb-3">
                        <a class="button-23 w-100 fs-6" style="border-radius: 10px; margin-bottom: 8px" href="<?php current_url(); ?>/Login/registrasi">Registrasi</a>
                        <a class="button-23 w-100 fs-6" id="primary-btn" onclick="check()">Login</a>
                    </div>
                </div>
            </div>
        </div>
